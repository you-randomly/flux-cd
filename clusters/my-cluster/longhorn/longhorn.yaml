...
metadata:
  ...
  labels:
    ...
    app.kubernetes.io/version: v1.6.0-rc2
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: longhorn-manager
        image: longhornio/longhorn-manager:v1.6.0-rc2
        ...
        - daemon
        - --engine-image
        - "longhornio/longhorn-engine:v1.6.0-rc2"
        - --instance-manager-image
        - "longhornio/longhorn-instance-manager:v1.6.0-rc2"
        - --share-manager-image
        - "longhornio/longhorn-share-manager:v1.6.0-rc2"
        - --backing-image-manager-image
        - "longhornio/backing-image-manager:v1.6.0-rc2"
        - --support-bundle-manager-image
        - "longhornio/support-bundle-kit:v0.0.33"
        - --manager-image
        - "longhornio/longhorn-manager:v1.6.0-rc2"
        - --service-account
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: longhorn-ui
        image: longhornio/longhorn-ui:v1.6.0-rc2
        imagePullPolicy: IfNotPresent
        volumeMounts:
        - name : nginx-cache
